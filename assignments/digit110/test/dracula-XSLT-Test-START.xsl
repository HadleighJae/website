 ...
 <xsl:template match="/">
    ...
    <xsl:template match="chapter" mode="toc">
        <tr>
            ...
            <td>
                <xsl:apply-templates select="string-join(sort(distinct-values(.//location)), ', ')" mode="toc"/>
            </td>
            <td>
                <xsl:apply-templates select="string-join(sort(distinct-values(.//tech)), ', ')" mode="toc"/>
            </td>
        </tr>
    </xsl:template>
