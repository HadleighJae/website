...
patterns = [
    ...
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Wehrwirtschaftsfuehrer"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "PROPAGANDA"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Monkey"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Juda"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Immovable Jewels"}}]},
    {"label": "GPE", "pattern": [{"TEXT": {"REGEX": "Indianapolis"}}]},
    {"label": "GPE", "pattern": [{"TEXT": {"REGEX": "Indiana"}}]},
    {"label": "PERSON", "pattern": [{"TEXT": {"REGEX": "Scripio Africanus"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Reaganbush"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "REBELS"}}]},
    {"label": "EVENT", "pattern": [{"TEXT": {"REGEX": "SHAN REBELLION"}}]},
    {"label": "EVENT", "pattern": [{"TEXT": {"REGEX": "REBELLION"}}]},
    {"label": "ORG", "pattern": [{"TEXT": {"REGEX": "Northwest Area Foundation"}}]},
    {"label": "ORG", "pattern": [{"TEXT": {"REGEX": "GE"}}]},
    {"label": "ORG", "pattern": [{"TEXT": {"REGEX": "Northrup Aircraft"}}]},
    {"label": "ORG", "pattern": [{"TEXT": {"REGEX": "Northwest Airlines"}}]},
    {"label": "LOC", "pattern": [{"TEXT": {"REGEX": "Pacific Northwest"}}]},
    {"label": "LOC", "pattern": [{"TEXT": {"REGEX": "Northwest"}}]},
    {"label": "NULL", "pattern": [{"TEXT": {"REGEX": "Northlake"}}]},
    ...
    {"label": "PERSON", "pattern": [{"TEXT": {"REGEX": "Bowman Gray Jr\."}}]},
    {"label": "PERSON", "pattern": [{"TEXT": {"REGEX": "Martin Luther King Jr\."}}]},
    ...
    {"label": "PERSON", "pattern": [{"TEXT": {"REGEX": "Vince Foster Jr\."}}]},
    {"label": "PERSON", "pattern": [{"TEXT": {"REGEX": "S\. Martin Teel Jr\."}}]},
...
outputPath = os.path.join(workingDir, '../anotheroutput')
