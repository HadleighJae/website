window.addEventListener('DOMContentLoaded', bunny, false); /* Always say false. Controls event bubbling which isn't what you want. This propagates event listener on ancestors and opens everything all at once */

function bunny() {
    alert ('Hi there! Looks like the page loaded! Yay!');
    var buttons = document.getElementsByTagName("button") /* Variables include 'let' 'var' and 'const'. Let and Var define things that already exist. The = defines the function */
